...
<div id="register-content"> 
	<h2 style="color:rgba(48, 129, 153,1);">Register To Have Full Access To Member Features</h2>
...
<div id="login-content"> 
	<h2 style="color:rgba(48, 129, 153,1);">Please Log In To Explore Full Features</h2>
	<form action="assets/inc/process.inc.php" method="post">         
		<fieldset><legend>&nbsp;</legend>             
			<label for="uname">Username</label> 
